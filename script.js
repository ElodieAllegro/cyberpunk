...
hemi.position.set(0, 2, 0); this.scene.add(hemi);
const dir = new THREE.DirectionalLight(0xffffff, 1.5);
dir.position.set(3, 3, 3); this.scene.add(dir);
const frontLight = new THREE.DirectionalLight(0xffffff, 1);
frontLight.position.copy(this.camera.position); this.scene.add(frontLight);
const fillLight = new THREE.PointLight(0xffffff, 1);
fillLight.position.set(-2, 1, 2); this.scene.add(fillLight);
